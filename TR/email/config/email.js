...
async function enviarlembreteDevolucao(email, nome, livroTitulo, dataDevolucao, diasRestantes) {
    try {
        const info = await transporter.sendMail({
            from: `"Biblioteca Libro" <${process.env.EMAIL_USER}>`,
            to: email,
            ...
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px;">
                    ...
                    ${diasRestantes <= 0 ? 
                        ...
                        `<p>Não se esqueça de devolver o livro até a data informada. Você pode <a href="${process.env.APP_URL || ""}/home/home.html" style="color: #4CAF50;">renovar o empréstimo</a> pelo sistema.</p>`
                    }
